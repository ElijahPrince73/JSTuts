...
/*var john = {
  ...
  presentation: function(style, timeOfDay) {
    if (style === 'formal') {
      console.log('Good morning lady\'s and gentlemen I\'m ' + this.name + ', I\'m a ' + this.job + ' and i\'m ' + this.age + ' years old.');
    } else if (style === 'friendly') {
      console.log('Hey whats yall Im ' + this.name + ', I\'m a ' + this.job + ' and i\'m ' + this.age + ' years old. Have a nice  ' + timeOfDay);
    }
  }
}
